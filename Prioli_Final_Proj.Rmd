...
<!-- Notes
  * Change example wrangle dataset to a simpler one (HDI takes up too much room in output)
  ...
  * Do a sensitivity analysis on cluster number via shiny
     * Clustering:  in Shiny app, write code to display "The United States is in " _fill in the blank_ "cluster"
     * Results of SA - OK to just describe Shiny results, and provide URL
  * Limitations:
...
```{r SPIplot, include = TRUE, echo = TRUE, warning = FALSE, message = FALSE, fig.width = 4, fig.height = 2.5}
SPI_hist
```
...
```{r kmeans_SPI_lifeexp, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 10, fig.height = 8}
