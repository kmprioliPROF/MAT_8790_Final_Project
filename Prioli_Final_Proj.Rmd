...
grid.arrange(HDIindex_hist, HDIcat_bar, HDIsumm_grob, nrow = 2, heights = c(0.8, 0.2),
             top = textGrob("Human Development Index", 
...
```{r SPI_country_out, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 6}
SPI_country_point
```
...
```{r kmeans_SPI_GDP, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 6}
kmdata <- kmdf(clusterdata, "country", "SPI", "logGDP")
