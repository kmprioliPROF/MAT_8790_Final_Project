...
<!-- Notes
  ...
  * Ensure all tables and figures are numbered
...
GDP_country_point <- ggplot(data = alldata_GDP_40, 
  ...
  ylab("Country") +
  ggtitle("Figure 10.  Gross Domestic Product by Country, Log Scale")
GDP_country_point
```
...
gender_country_point <- ggplot(data = alldata_gender_40, 
  ...
  xlab("Gender Equality Index") +
  ylab("Country") +
  ggtitle("Fig. 13.  Gender Equality Index by Country")
